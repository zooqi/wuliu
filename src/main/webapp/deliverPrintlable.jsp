...
<body style="font-size: 18px;text-align: center; font-family: '宋体'">
 桂林百顺物流有限公司&nbsp;&nbsp;&nbsp;
 </br>
  <table width="205" align="center" cellspacing="0"
			...
			<tr>
				<td>货&emsp;号</td>
				<td id="goBank" ">
				<input type="text" style="width: 140px; font-size: 17px;border: 0px;"
			...
			<tr>
				<td >收货人</td>
				<td id="goForMan" ><input type="text" style="width: 140px; font-size: 17px; border: 0px;"
					value="<%=json.has("goForMan") ? json.get("goForMan") : ""%>" />
				</td>
			</tr>
			<tr>
				<td>电&emsp;话</td>
				<td id="goForPhone" ><input type="text" style="width: 140px; font-size: 17px; border: 0px;"
					value="<%=json.has("goForPhone") ? json.get("goForPhone") : ""%>" />
				</td>
			</tr>
			<tr>
				<td>日&emsp;期</td>
				<td id="logSendDate" ><input type="text" style="width: 140px; font-size: 17px; border: 0px;"
			...
			style='font-size: 15px; width: 75px; height: 30px; background-color: #F0F0F0' />
